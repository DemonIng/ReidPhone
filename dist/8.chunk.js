...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/djw/Downloads/前端项目的架构/project/src/components/activityPage.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	...
	if (true) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-1f8c59b8", __vue_options__)
	  } else {
	    hotAPI.reload("data-v-1f8c59b8", __vue_options__)
	  }
	})()}
	if (__vue_options__.functional) {console.error("[vue-loader] activityPage.vue: functional components are not supported and should be defined in plain js files using render functions.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
		components: {
			activityMain: _brandMain2.default
		}
	}; //
	//
	//
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;
	  return _h('div', [_h('activity-main', {
	    attrs: {
	      "items": [{
	        meg: '最新活动',
	        url: '/latestActivity'
	...
	if (true) {
	  module.hot.accept()
	  if (module.hot.data) {
	     __webpack_require__(38).rerender("data-v-1f8c59b8", module.exports)
	  }
	}
