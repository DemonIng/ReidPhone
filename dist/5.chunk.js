...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/djw/Downloads/前端项目的架构/project/src/components/appointment.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	...
	if (true) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-46ffd695", __vue_options__)
	  } else {
	    hotAPI.reload("data-v-46ffd695", __vue_options__)
	  }
	})()}
	if (__vue_options__.functional) {console.error("[vue-loader] appointment.vue: functional components are not supported and should be defined in plain js files using render functions.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    components: {
	        appointment: _registerMain2.default
	    }
	}; //
	//
	//
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;
	  return _h('div', [_h('appointment', {
	    attrs: {
	      "text": '课程试听预约',
	      "text2": '免费名额有限，现在就留下您的电话号码，我们的顾问会尽快联系您，并为您预约一个合适的时间。',
	      "text3": '点此确认',
	      "megs": [{
	        m: '宝宝姓名：',
	        inputBool: true,
	...
	if (true) {
	  module.hot.accept()
	  if (module.hot.data) {
	     __webpack_require__(38).rerender("data-v-46ffd695", module.exports)
	  }
	}
