...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/djw/Downloads/前端项目的架构/project/src/components/register.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	...
	if (true) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-da9136c6", __vue_options__)
	  } else {
	    hotAPI.reload("data-v-da9136c6", __vue_options__)
	  }
	})()}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  components: {
	    register: _registerMain2.default
	  },
	  methods: {},
	  mounted: function mounted() {}
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;
	  return _h('div', [_h('register', {
	    attrs: {
	      "text": '即刻注册获得免费试听课程',
	      "text2": '成功注册为会员后，您将可以免费获得一次试听瑞德课程的机会并在光临瑞德启蒙教育中心后得到一份精美礼物',
	      "text3": '点此确认',
	      "megs": [{
	        m: '用户名：',
	        inputBool: true,
	...
	if (true) {
	  module.hot.accept()
	  if (module.hot.data) {
	     __webpack_require__(38).rerender("data-v-da9136c6", module.exports)
	  }
	}
